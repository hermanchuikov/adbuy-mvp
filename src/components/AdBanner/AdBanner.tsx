...
const AdBanner: FC<IAdBannerProps> = (props) => {
  ...
  const pauseBlock = useRef().current;

  console.log('change');


  useEffect(() => {
    if (type === 'tiktok' && videoUrl) {
      console.log('tiktok');
      setLoading(true);
      const videoLink = `data:video/mp4;base64,${videoUrl}`;

      fetch(videoLink)
          .then((res) => res.blob())
          .then((data) => URL.createObjectURL(data))
          .then((file) => setVideoFilePath(file))
          .then(() => console.log(videoFilePath))
          ...
          <div className={classes.facebookBlock}>
            <div className={classes.facebookHeader}>
              <div className={classes.facebookHeaderBlock}>
                ...
                />
                <div>
                  <h6 className={classes.facebookHeaderTitle}>{username}</h6>
            ...
            <h3 className={classes.facebookAdTitle}>{description}</h3>
            {/* image */}
            ...
            <div className={classes.facebookInfoInner}>
              <div className={classes.facebookInfoBlock}>
                <p className={classes.facebookInfoUrl}>{url}</p>
            ...
            <div className={classes.tiktokInfo}>
              ...
              <div className={classes.tiktokFooter}>
                <div className={classes.tiktokFooterBlock}>
                  ...
                  <div className={classes.tiktokAd}>
                    <p className={classes.tiktokAdText}>Ad</p>
                  </div>
                  <div>
                ...
                <div className={classes.footerControls}>
                  <div className={classes.footerControlsButton}>
                    <p className={classes.footerButtonText}>{button}</p>
                  </div>
                  <img
                      src="https://i.postimg.cc/Y093g3JJ/Adbuy-new-logo.png"
